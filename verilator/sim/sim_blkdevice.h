...
public:
	...
	IData* sd_lba[kVDNUM];
	CData* sd_rd;           // 2-bit in MacIIvi
	CData* sd_wr;           // 2-bit in MacIIvi
	CData* sd_ack;          // 2-bit in MacIIvi
	CData* sd_buff_addr;    // 8-bit for MacIIvi
	SData* sd_buff_dout;    // 16-bit for MacIIvi
	SData* sd_buff_din[kVDNUM];  // 16-bit for MacIIvi
	CData* sd_buff_wr;
	CData* img_mounted;     // 2-bit in MacIIvi
	CData* img_readonly;
	QData* img_size;
