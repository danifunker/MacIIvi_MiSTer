...
int main(int argc, char** argv, char** env) {
    ...
    // combinationally-reloaded VIEW of the true register n17415_q (shadow:
    // n17417_q) — poking `regfile` is overwritten on the next eval. Inject into
    ...
    auto set_reg = [](int i, uint32_t v) {
        VERTOPINTERN->tg68k_tests__DOT__cpu__DOT__n17415_q[15 - i] = v;
        VERTOPINTERN->tg68k_tests__DOT__cpu__DOT__n17417_q[15 - i] = v;
    ...
    // ghdl names n17577_q (`assign usp = n17577_q;` in TG68KdotC_Kernel.v). The
    // name is POSITIONAL and changes on every reconvert — re-derive with
    //   grep "assign usp = " rtl/tg68k/TG68KdotC_Kernel.v
    // and update tg68k_tests.vlt to match. (n15135 -> n16595_q -> n17577_q.) The
    ...
    auto set_usp = [](uint32_t v) {
        VERTOPINTERN->tg68k_tests__DOT__cpu__DOT__n17577_q = v;
    };
    ...
    if (argc >= 2 && std::string(argv[1]) == "--probe-regs") {
        ...
        VERTOPINTERN->tg68k_tests__DOT__cpu__DOT__n17415_q[15] = d0;
        VERTOPINTERN->tg68k_tests__DOT__cpu__DOT__n17417_q[15] = d0;
