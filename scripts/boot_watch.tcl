# Rapid whole-boot probe sampler: waits for the MacIIvi core to appear on the
...
# Wait (up to 10 min) for a bitstream with ISSP probes — i.e. the MacIIvi core.
emit "WAITING for MacIIvi core (probes) on the chain..."
set info ""
